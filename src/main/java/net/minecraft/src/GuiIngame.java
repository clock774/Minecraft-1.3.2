...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (this.mc.playerController.func_78763_f() && this.mc.thePlayer.experienceLevel > 0)
        {
            ...
            var37 = (var6 - var8.getStringWidth(var34)) / 2;
            var40 = var7 - 31 - 4;
            var8.drawString(var34, var37 + 1, var40, 0);
            var8.drawString(var34, var37 - 1, var40, 0);
            var8.drawString(var34, var37, var40 + 1, 0);
            var8.drawString(var34, var37, var40 - 1, 0);
            var8.drawString(var34, var37, var40, var12);
            this.mc.mcProfiler.endSection();
        }
        ...
        if (this.mc.isDemo())
        {
            ...
            {
                var35 = String.format(StatCollector.translateToLocal("demo.remainingTime"), new Object[] {StringUtils.ticksToElapsedTime((int)(120500L - this.mc.theWorld.getWorldTime()))});
            }
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            {
                Chunk var49 = this.mc.theWorld.getChunkFromBlockCoords(var46, var23);
                this.drawString(var8, "lc: " + (var49.getTopFilledSegment() + 15) + " b: " + var49.getBiomeGenForWorldCoords(var46 & 15, var23 & 15, this.mc.theWorld.getWorldChunkManager()).biomeName + " bl: " + var49.getSavedLightValue(EnumSkyBlock.Block, var46 & 15, var22, var23 & 15) + " sl: " + var49.getSavedLightValue(EnumSkyBlock.Sky, var46 & 15, var22, var23 & 15) + " rl: " + var49.getBlockLightValue(var46 & 15, var22, var23 & 15, 0), 2, 96, 14737632);
            }
        ...
        if (this.mc.gameSettings.keyBindPlayerList.pressed && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.playerInfoList.size() > 1))
        {
            ...
            List var38 = var41.playerInfoList;
            var13 = var41.currentServerMaxPlayers;
            var37 = var13;

            for (var40 = 1; var37 > 20; var37 = (var13 + var40 - 1) / var40)
            {
                ++var40;
            }
            ...
            byte var44 = 10;
            drawRect(var17 - 1, var44 - 1, var17 + var16 * var40, var44 + 9 * var37, Integer.MIN_VALUE);
            ...
            for (var19 = 0; var19 < var13; ++var19)
            {
                ...
                if (var19 < var38.size())
                {
                    ...
                    this.zLevel += 100.0F;
                    this.drawTexturedModalRect(var20 + var16 - 12, var46, 0 + var48 * 10, 176 + var51 * 8, 10, 8);
                    this.zLevel -= 100.0F;
                }
            }
        }
