...
public class EntityRenderer
{
    ...
    public void updateCameraAndRender(float par1)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            int var12 = var10 - Mouse.getY() * var10 / this.mc.displayHeight - 1;
            ...
            if (this.mc.theWorld != null)
            {
                ...
                {
                    this.mc.ingameGUI.renderGameOverlay(par1, this.mc.currentScreen != null, var11, var12);
                }
            ...
            {
                GL11.glClear(256);
                this.mc.currentScreen.drawScreen(var11, var12, par1);
