...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (this.loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, (String)null))
        {
            ...
            double var20 = par1EntityPlayer.field_71091_bM + (par1EntityPlayer.field_71094_bP - par1EntityPlayer.field_71091_bM) * (double)par2 - (par1EntityPlayer.prevPosX + (par1EntityPlayer.posX - par1EntityPlayer.prevPosX) * (double)par2);
